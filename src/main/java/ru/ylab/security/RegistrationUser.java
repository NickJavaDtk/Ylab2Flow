...
public class RegistrationUser {
    ...
    private final String before = "Вы выбрали 1\nДалее вам необходимо ввести сначала логин, потом пароль, а после также выбрать роль\n" +
            "(Пользователь или Администратор) создаваемого пользователя.";
    ...
    public Users createUsers() {
        ...
        while (true) {
            username =  readConsole.readString();
    ...
    private boolean checkUserName(String username) {
        return InternalMemory.usersList.stream( ).anyMatch(user -> user.getUsername( ).equals(username));
    }
